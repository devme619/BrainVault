...
def evaluate_with_gemini(extracted_text: str, api_key: str, model_name: str = "gemini-1.5-flash") -> Dict[str, Any]:
    ...
    try:
        ...
        if response.status_code != 200:
            ...
            return {"error": f"Gemini API Error ({response.status_code}): {err_detail}"}
...
def evaluate_llm_answer(extracted_text: str, provider: str, api_key: str, model_name: str) -> Dict[str, Any]:
    ...
    if provider_clean == "gemini":
        return evaluate_with_gemini(extracted_text, api_key, model_name or "gemini-1.5-flash")
